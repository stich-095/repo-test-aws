...
export default function UploadVaucherCollateralCancellation({ uid_collateral }) {
    ...
    const handleUpload = async () => {
        ...
        formData.append('vaucher_cancelation_collateral', selectedFiles[0]);
    
        try {
            const response = await axiosInstance.patch(`/secure_payment/collateral/${uid_collateral}/`, formData, {
                headers: {
