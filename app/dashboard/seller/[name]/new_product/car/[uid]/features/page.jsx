...
export default function FeaturesPage({ params }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            router.push(`/dashboard/seller/${name}/new_product/car/${data.uid}/features`);
        ...
        <div style={{ width: "100%", display: "flex", flexDirection: "column", minHeight: "100vh", alignItems: "center" }}>
            <div style={{ width: "60vw" }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" style={{ marginTop: '20px', padding: '10px 20px', borderRadius: '5px', backgroundColor: '#2b61e5', color: 'white', border: 'none' }}>
                        Enviar
                    </button>
                </form>
            </div>
